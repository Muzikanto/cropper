...
function imageMoveToAngle(crop, prevImageCrop, nextImageCrop, zoom, nextWidth, nextHeight) {
    ...
    const nextImage = Object.assign({}, nextImageCrop);
...
exports.default = imageMoveToAngle;
